      ...
      child: Column(
        children: [
                  ...
                  trailing: Row(
                    ...
                    children: [
                      InkWell(
                          onTap: () {
                            setState(() {
                              _orderService.mapLauncher(_customer?["latitude"],_customer?["longitude"], _customer?["firstName"]);
                            });
                          },
                        child: Container(
          ...
          ExpansionTile(
            ...
            expansionAnimationStyle: AnimationStyle(curve: Curves.bounceOut,duration: Duration(seconds: 1)),
            title: Text(
              "Order Details",
